...
{
  "role_type": "jwt",
  "bound_audiences": ["https://github.com/oneil6677"],
  "user_claim": "sub",
  "bound_claims_type": "glob",
  "bound_claims": {
    "sub": "repo:oneil6677/DevSecOps-course:*"
  },
  ...
  deploy:
    ...
    steps:
      ...
      - name: Fetch Keys from Vault
        ...
        with:
          url: http://<YOUR_EC2_IP>:8200 # replace <YOUR_EC2_IP> with the ipaddress of the server running vault
